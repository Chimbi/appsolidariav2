...
class __PageSelectorState extends State<_PageSelector> {
  ...
  Widget build(BuildContext context) {
    ...
    return StoreConnector<AppState, Page1ViewModel>(
        converter: (store) {
                                    ...
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: DropdownButtonFormField(
                                          ...
                                          value:
                                              vm.page1formState.dropdownValue,
...
//                                                      .selectedUser = value;
                                  ...
                                  ExpansionTile(
                                    ...
                                    children: <Widget>[
                                            ...
                                            vm.page1formState
                                                ...
                                                ? vm
                                                    ...
                                                    vm
                                                        ...
                                                        .substring(3, 5) +
                                                    "-" +
                                                    (int.parse(vm.page1formState.initialDateController.text.substring(6, 10)) +
                                      ...
                                      DateTimePickerFormField(
                                        ...
                                        controller: vm
                                            .page1formState.finalDateController,
                                        ...
                                        initialValue: (vm.page1formState.finalDateController.text != "" &&
                                                vm.page1formState.periodoController.text !=
                                                    "")
                                            ? DateTime.parse((int.parse(vm.page1formState.finalDateController.text.substring(6, 10)) +
                                                        int.parse(vm
                                                            .page1formState
                                                            .periodoController
                                                            .text))
                      ...
                      cacheExtent:
                          3, // How Many pages you want to save in cache
                    ),
                  ),
                ),
              ],
